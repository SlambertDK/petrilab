...
[36] Bayley, G. V., & Hammersley, J. M. (1946). The "Effective" Number of Independent Observations in an Autocorrelated Time Series. *Supplement to the JRSS*, 8(2), 184–197. (AR(1) effective-sample-size correction $n_\text{eff}=n(1-\rho)/(1+\rho)$, Section 4.4.)

[37] Wasserstein, R. L., & Lazar, N. A. (2016). The ASA Statement on p-Values: Context, Process, and Purpose. *The American Statistician*, 70(2), 129–133. (Effect sizes and confidence over bare p-values, Section 4.4.)
